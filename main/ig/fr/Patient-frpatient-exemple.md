# frpatient-exemple - Confluences Téléexpertise v0.1.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://interop.esante.gouv.fr/ig/fhir/teleexpertise-confluence/StructureDefinition/fr-patient"]
  },
  "identifier" : [{
