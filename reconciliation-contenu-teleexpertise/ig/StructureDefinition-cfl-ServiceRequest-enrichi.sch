...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile CFLServiceRequestRequerantProfile
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:ServiceRequest">
      ...
      <sch:assert test="count(f:extension[@url = 'http://example.org/fhir/fish/StructureDefinition/fr-coreServiceRequest-urlLtle|0.1.0']) &gt;= 1">extension with URL = 'http://example.org/fhir/fish/StructureDefinition/fr-coreServiceRequest-urlLtle|0.1.0': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/fhir/fish/StructureDefinition/fr-coreServiceRequest-urlLtle|0.1.0']) &lt;= 1">extension with URL = 'http://example.org/fhir/fish/StructureDefinition/fr-coreServiceRequest-urlLtle|0.1.0': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
