...
## Resource Profile: FR Core Patient CFL 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.teleexpertise-confluence|current/StructureDefinition/StructureDefinition-fr-core-patient-cfl.json)
...
Other representations of profile: [CSV](../StructureDefinition-fr-core-patient-cfl.csv), [Excel](../StructureDefinition-fr-core-patient-cfl.xlsx), [Schematron](../StructureDefinition-fr-core-patient-cfl.sch) 
