...
## Profil de ressource: CFL Practitioner Profile 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.teleexpertise-confluence|current/StructureDefinition/cfl-practitioner)
...
Autres représentations du profil : [CSV](../StructureDefinition-cfl-practitioner.csv), [Excel](../StructureDefinition-cfl-practitioner.xlsx), [Schematron](../StructureDefinition-cfl-practitioner.sch) 
