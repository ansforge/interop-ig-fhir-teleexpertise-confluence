...
* Use this Extension: [CFL ServiceRequest Enrichi Profile](StructureDefinition-cfl-ServiceRequest-enrichi.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.teleexpertise-confluence|current/StructureDefinition/StructureDefinition-url-ltle.json)
...
Other representations of profile: [CSV](../StructureDefinition-url-ltle.csv), [Excel](../StructureDefinition-url-ltle.xlsx), [Schematron](../StructureDefinition-url-ltle.sch) 
